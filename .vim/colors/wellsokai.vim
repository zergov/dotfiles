...
hi Function ctermfg=110 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
...
hi CursorLine ctermfg=NONE ctermbg=236 cterm=bold guifg=white guibg=yellow gui=bold
